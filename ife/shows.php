...
<div id="wrapper">
	...
	?>
    <div id="middle">
	<h3  style="margin:0 0 0 0;"><a href="#" class="featured"><img src="img/hamburger.png" style="margin-right:10px;"/><span id="head">Featured</span> Shows</a></h3>
    <div class="leftnav">
    	<div style="margin-top:30px;">
    	<?php
				include_once "leftlist.php";
		?>
          </div>     
            </div>
        <div class="scrollframe">
            <div id="tilewrapper">
                <div class="tile hidden">
                 ...
                 <div id="include">
                     <?php
                        include_once "featuredshows.php";
                        ?>
                 </div>
            </div> 
        </div> <!--endscrollframe-->
