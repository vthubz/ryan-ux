...
<div id="wrapper">
	...
	?>
    <div id="middle">
	<h3  style="margin:0 0 0 0;"><a href="#" class="featured">Search Results: XYZ</h3>
    <div class="leftnav">
    ...
    <div id="searchbar">
    	<div id="searchwrap">
        	<form action="searchresults.php" class="searchform">
